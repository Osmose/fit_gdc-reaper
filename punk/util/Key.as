package punk.util 
{
	/// @info	A static class used for accessing the keyCodes or names of specific keys on the keyboard.
	public class Key 
	{
		/// @info	[STATIC] Constants for the arrow keys.
		public static const LEFT:int = 37;
		public static const UP:int = 38;
		public static const RIGHT:int = 39;
		public static const DOWN:int = 40;
		
		/// @info	[STATIC] Constants for primary keyboard buttons.
		...
		/// @info	[STATIC] Constants for the keyboard letters.
		...
		/// @info	[STATIC] Constants for the function keys.
		...
		/// @info	[STATIC] Constants for the numpad keys.
		...
		/// @info	[STATIC] Gets the name of a key.
		/// @param	char	The keyCode of the key you want the name of.
